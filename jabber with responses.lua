...
function clean_rpid(msg, with_from)
    ...
    if rpid ~= nil then
        ...
        -- extract x-cisco-callback-number (pre-transform) or x-cisco-number (post-transform)
...
function M.outbound_18X_ANY(msg)
    msg = clean_rpis(msg, false)
end

function M.outbound_200_ANY(msg)
    msg = clean_rpis(msg, false)
end
